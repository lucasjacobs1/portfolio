package individualapplication.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(individualapplication.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
        //check authentication on methods
    }

    @Pointcut("@within(individualapplication.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedClass() {
        //check authentication on classes
    }
