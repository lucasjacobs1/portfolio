...
namespace MediaBazaar.Data_Layer
{
    public class UserDAL : BaseDAL
    {
        public bool EditEmployeeWithPassword(Employee employee, string newPassword)
        {
            ...
            try
            {
                String sqlStatement = $"UPDATE employee SET fist_name = '{employee.FirstName}', last_name = '{employee.LastName}', email = '{employee.Email}', street = '{employee.Street}', city = '{employee.City}', postalcode = '{employee.PostalCode}', housenumber = '{employee.HouseNumber}', salary = {employee.Salary}, bsn = {employee.Bsn}, phone = {employee.Phonenumber}, role = {employee.Role}, fte = {employee.FTE} WHERE id = {employee.ID};";
                ...
                sqlCommand.Parameters.AddWithValue("@firstname", employee.LastName);
        ...
        public bool EditEmployeeWithoutPassword(Employee employee)
        {
            try
            {
                String sqlStatement = $"UPDATE employee SET first_name = '{employee.FirstName}', last_name = '{employee.LastName}', email = '{employee.Email}', street = '{employee.Street}', city = '{employee.City}', postalcode = '{employee.PostalCode}', housenumber = '{employee.HouseNumber}', salary = {employee.Salary}, bsn = {employee.Bsn}, phone = {employee.Phonenumber}, role = {employee.Role}, fte = {employee.FTE} WHERE id = {employee.ID};";
                MySqlCommand sqlCommand = new MySqlCommand(sqlStatement, GetDBConnection());
